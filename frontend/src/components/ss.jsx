        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-gray-600">
              Don't just take our word for it. Here's what customers think about our service.
            </p>
          </div>
              ...
              <div key={index} className="bg-gray-50 rounded-2xl p-8 shadow-md hover:shadow-lg transition-shadow duration-300">
                <div className="flex items-center mb-6">
                  <img 
                    ...
                    className="w-14 h-14 rounded-full object-cover border-2 border-blue-600 mr-4"
                  />
                  <div>
                ...
                <p className="text-blue-600 font-medium text-sm">Verified Customer</p>
              </div>
            ))}
          </div>
